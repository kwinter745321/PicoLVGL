# temp_humidity_lcdbus.py
#
# Updated: 19 May 2025 for MP on ESP32
# Original: https://github.com/fabse-hack/temp_humidity_micropython_lvgl
#
# MIT License
# LVGL (9.2.2) MicroPython (1.24.1) Binding compiled on 2025-05-18; Generic ESP32S3 module with Octal-SPIRAM with ESP32S3
...
reset_button = Pin(45, Pin.IN, Pin.PULL_DOWN)
...
def do_closing():
    ...
    #event_loop.disable()
    #event_loop.deinit()
    scrn.set_style_bg_color(lv.color_black(), 0)
    time.sleep(1)
    scrn.clean()
    time.sleep(1)
    reset()
