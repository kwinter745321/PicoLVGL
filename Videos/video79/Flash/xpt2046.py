...
class Xpt2046_hw(object):
    ...
    def __init__(self,*,
        ...
        #print("xpt2046 width,height,rot:",width,height,rot)
        '''
...
#     def update_res(self,width,height,rot):
#         print("update_res:",width,height,rot)
#         self.dim,self.rot=(width,height),(rot%4)
#         self.xy_scale=[self.dim[ax]*1./(self.xy_range[ax][1]-self.xy_range[ax][0]) for ax in (0,1)]
#         self.xy_origin=[self.xy_range[ax][0] for ax in (0,1)]
