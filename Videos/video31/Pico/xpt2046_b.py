...
# Portrait Dimensions for ILI9341
#hres = 240
#vres = 320
# Portrait Dimensions for ST7796
# hres = 320
# vres = 480
...
class Xpt2046_hw(object):
    ...
    def __init__(self,*,
        spi: machine.SPI,cs,bits=12,ranges=((100,1900),(200,1950)),width=320,height=480,rot=XPT2046_PORTRAIT):
#         if (rot % 2) == 0:
#             print("XPT2046 driver: rot",rot," Display width,height:",width,height)
#         else:
#             print("XPT2046 driver: rot",rot," Display width,height:",height,width)
        '''
