# test_chart2_ulab.py
#
# Updated:    28 April 2025 for 320x480 displays
#
...
scr = lv.obj()
try:
    from display_driver_st7796 import HardReset
    h = HardReset(scr)
except ImportError:
    pass
...
xaxis = lv.scale(chrt)
xaxis.set_size( chrt_wd-60, lv.pct(100) )
...
xaxis.set_y(chrt_ht-10)
xaxis.set_range(0,datacount-1)
...
xaxis.set_style_line_width(3, lv.PART.INDICATOR)
xaxis.set_style_line_color(lv.palette_main(lv.PALETTE.BLUE), lv.PART.INDICATOR)
...
yaxis.set_style_line_width(3, lv.PART.INDICATOR)
yaxis.set_style_line_color(lv.palette_main(lv.PALETTE.BLUE), lv.PART.INDICATOR)
...
btn.align_to(scr, lv.ALIGN.BOTTOM_MID,0,-20)
