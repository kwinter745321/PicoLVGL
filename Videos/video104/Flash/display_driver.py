...
# MIT License
# MicroPython v1.29.0-dirty on 2026-08-26;
# Raspberry Pi Pico 2 W with RP2350
# Raspberry Pi Pico2 and Pico2_W (RP2350)
# LVGL 9.5
# ulab 6.12
# 
import lvgl as lv
...
# Orientation for all except ST7796
PORTRAIT = const(0)
LANDSCAPE = const(1)
...
#disp = ili9xxx.Ili9488(spi=spi, dc=9, cs=13, rst=8, rot=PORTRAIT)
# 3.5 inch ILI9488 Capacitive touch
#disp.write_register(0x21, b"\x00")
# ILI9488 (18 bit interface)
#disp = ili9xxx.Ili9488b(spi=spi, dc=9, cs=13, rst=8, rot=PORTRAIT)
# ST7796 Orientation: 0=Landscape 1=portrait
disp = ili9xxx.St7796(spi=spi, dc=9, cs=13, rst=8, rot=0)
...
def tsread(indev_drv, data) -> int:
    ...
    if coords:
        ...
        #print(disp.rot,data.point.x, data.point.y)
        return True
