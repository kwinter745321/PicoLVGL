...
# Initialize LVGL
lv.init()
print("Running LVGL %d.%d.%d-%s" % (lv.version_major(), lv.version_minor(), lv.version_patch(), lv.version_info() )  )

# Initialize display  ILI9341 SPI=20M T=2M
spi = SPI(0, baudrate=80_000_000, sck=Pin(18), mosi=Pin(19), miso=Pin(16))
...
if disp.display_type == 'st7796':
    touch = xpt2046.Xpt2046_hw(spi=tspi,cs=22,width=(320),height=(480),rot=disp.rot)
else:
    touch = xpt2046.Xpt2046_hw(spi=tspi,cs=22,width=(240),height=(320),rot=disp.rot)
