...
#
# Updated: 15 May 2025 for MP on RPI_Pico_W
# Updated for RPI PicoW by: KW Services
...
import machine
import network
#import task_handler  #used by ESP32
...
try:
    ...
    print("If secret file is missing, just update lines 33-34 instead.")
...
class WiFiManager:
    ...
    def connect_to_wifi(self):
        #https://forums.raspberrypi.com/viewtopic.php?t=363250
        # above link suggests ways to make connect() reliable
        try:
...
async def main():
    task0 = asyncio.create_task(do_reset())  # so I can reset()
