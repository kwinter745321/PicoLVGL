...
#spi = SoftSPI(baudrate=40_000_000, sck=Pin(2), mosi=Pin(3), miso=Pin(4))
...
#disp = ili9xxx.Ili9341(spi=spi, dc=3, cs=13, rst=2, rot=LANDSCAPE)
...
disp = ili9xxx.St7796(spi=spi, dc=3, cs=13, rst=2, rot=1)
