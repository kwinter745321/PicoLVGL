...
sdspi = SPI(1, baudrate=2_000_000, sck=Pin(10), mosi=Pin(11), miso=Pin(12))
print("Init SPI")
...
# touch call back for the ILI9341 display
@micropython.native
def tsread(indev_drv, data) -> int:
    ...
    if coords:
        x, y = coords
        # comment out below if you use the HitLetgo 2.4 inch display
        y = int(scale_value( y, 240, 1, 1, 240))   #2.8 or 3.2 inch display
        coords = (x,y)
